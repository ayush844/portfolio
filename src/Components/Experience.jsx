...
const Experience = () => {
  return (
    <div className='border-b border-neutral-900 pb-4'>
        <motion.h2 whileInView={{y: 0, opacity: 1}} initial={{y: -100, opacity: 0}} transition={{duration: 1.5}}   className='my-20 text-center text-5xl'>Experience</motion.h2>
        <div>
                ...
                <div key={index} className='flex flex-wrap mb-8 lg:justify-center'>
                    ...
                    <motion.div whileInView={{x: 0, opacity: 1}} initial={{x: 100, opacity: 0}} transition={{duration: 1}}  className="w-full max-w-xl lg:w-3/4">
                        <h6 className='mb-2 font-semibold text-2xl'>
                            {experience.role} - <span className='text-md text-purple-300'>{experience.company}</span>
                        </h6>
